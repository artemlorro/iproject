...
function addImageBlock(key, file) {
    var delUrl = '/admin/content/delete-image/model/' + MODEL_NAME + '/key/' + key + '/id/' + ROW_ID + '/file/' + file.filename + '/';
...
function addFileBlock(key, file) {
    var delUrl = '/admin/content/delete-file/model/' + MODEL_NAME + '/key/' + key + '/id/' + ROW_ID + '/file/' + file.filename + '/';
